...
function ComboBox(props) {
    ...
    function handleInputFocused(e) {
        ...
        placeholder2.current.style.transform = "translate(-20%,-50%)";
        }, 100);
    ...
    return (
        ...
        <div style={{paddingInline: "0px", justifyContent:"start"}} className="input-box">
            ...
            <select name={props.name} className='input'
                    style={{paddingInline: "10px", width:"100%"}}
                    onFocus={e=>handleInputFocused(e)} 
                    onBlur={e=>handleInputBlurred(e)} >
                <option value=""></option>
                {props.children}
