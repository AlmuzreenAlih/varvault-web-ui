...
export function Weight(props) {
    return (
        <svg style={{ backgroundColor: colorArray[2] }} className="unit-symbol" width="196" height="198" viewBox="0 0 196 198" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="98.5" cy="26.5" r="21.5" stroke="black" strokeWidth="10"/>
            <path d="M6.8654 160.213L31.7419 68.2134C34.8078 56.8749 45.0949 49 56.8406 49H138.333C149.948 49 160.154 56.7036 163.337 67.8735L189.559 159.873C194.291 176.479 181.821 193 164.554 193H31.964C14.8437 193 2.39661 176.74 6.8654 160.213Z" fill="black" stroke="black" strokeWidth="10"/>
        </svg>
    )
}
